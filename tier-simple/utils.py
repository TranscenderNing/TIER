...
def load_representation_model(
    model_path, dtype, device, tokenizer_len, need_resize=False, tier_config=None
):
...
def get_args():
    ...
    parser.add_argument("-e", "--num_train_epochs", type=int, help="1", default=6)
    ...
    parser.add_argument(
        "-output_dir", "--output_dir", type=str, default="./tier_simple_results"
    )
